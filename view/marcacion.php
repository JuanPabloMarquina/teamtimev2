...
<body>
    ...
    <script>
        ...
        function enviarMarcacion(tipo) {
            ...
            const hora = document.getElementById('horaActual').innerText; // Captura la hora mostrada
            //const fecha = document.getElementById('fechaActual').innerText; // Captura la fecha mostrada
            ...
            // Obtener fecha actual y formatearla a YYYY-MM-DD
            const now = new Date();
            const anio = now.getFullYear();
            const mes = String(now.getMonth() + 1).padStart(2, '0'); // Mes empieza en 0
            const dia = String(now.getDate()).padStart(2, '0');
            const fecha = `${anio}-${mes}-${dia}`; // Formato correcto
            ...
            //enviando hora marcada
            const inputHora = document.createElement('input');
            inputHora.type = 'hidden';
            inputHora.name = 'hora';
            inputHora.value = hora;

             // Enviar fecha marcada en formato Y-m-d
